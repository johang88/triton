...
namespace Triton.Samples
{
	class TerrainGame : Triton.Samples.BaseGame
	{
		...
		protected override void LoadResources()
		{
			...
			{
				var material = Resources.Load<Graphics.Resources.Material>("/materials/terrain");
				var compositeMaterial = Resources.Load<Graphics.Resources.Material>("/materials/terrain_composite");
