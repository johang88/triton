...
{
	public class Vector4AddNode : NodeGraphNode
	{
		public Vector4AddNode(XmlTreeNode p_TreeNode, NodeGraphView p_View)
			: base(p_TreeNode, p_View)
		{
			Setup();
		}

		public Vector4AddNode(int p_X, int p_Y, NodeGraphView p_View, bool p_CanBeSelected)
		...
		private void Setup()
		{
			...
			this.m_Connectors.Add(new NodeGraphConnector("B", this, ConnectorType.InputConnector, 1, "Vector4"));
