...
namespace Triton
{
	public struct BoundingBox : IEquatable<BoundingBox>
	{
		...
		private static readonly Vector3 MaxVector3 = new Vector3(float.MaxValue, float.MaxValue, float.MaxValue);
		private static readonly Vector3 MinVector3 = new Vector3(float.MinValue, float.MinValue, float.MinValue);
		...
		{
			var corner = new Vector3(sphere.Radius, sphere.Radius, sphere.Radius);
