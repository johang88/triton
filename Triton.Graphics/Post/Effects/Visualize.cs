	...
	public class Visualize : BaseEffect
	{
		...
		public void Render(VisualizationMode mode, RenderTarget gbuffer, RenderTarget ssao, RenderTarget input, RenderTarget output)
		{
			...
			_backend.BeginInstance(_shader.Handle,
				...
				new int[] { _backend.DefaultSamplerNoFiltering, _backend.DefaultSamplerNoFiltering, _backend.DefaultSamplerNoFiltering, _backend.DefaultSamplerNoFiltering, _backend.DefaultSamplerNoFiltering });
