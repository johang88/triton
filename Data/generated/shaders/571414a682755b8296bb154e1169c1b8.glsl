...
float f_4 = 1;
float f_5 = 0;
float f_6 = texture(sampler_5, texCoord).z;
float v_7 = mix(f_4, f_5, f_6);
return v_7;
...
float f_8 = 0.6;
float f_9 = 0.7;
float f_10 = texture(sampler_6, texCoord).x;
float v_11 = mix(f_8, f_9, f_10);
float f_12 = 1;
float f_13 = texture(sampler_7, texCoord).y;
float v_14 = mix(v_11, f_12, f_13);
return v_14;
