...
uniform sampler2D sampler_43;
uniform sampler2D sampler_44;
uniform sampler2D sampler_45;
vec4 get_diffuse() {
vec4 v_0 = texture(sampler_43, texCoord);
return pow(v_0, vec4(2.2));

}
vec3 get_normals() {
vec4 v_1 = texture(sampler_44, texCoord);
...
float get_roughness() {
float f_5 = texture(sampler_45, texCoord).x;
return f_5;
