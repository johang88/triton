...
uniform sampler2D sampler_49;
uniform sampler2D sampler_50;
uniform sampler2D sampler_51;
vec4 get_diffuse() {
vec4 v_0 = texture(sampler_49, texCoord);
return pow(v_0, vec4(2.2));

}
vec3 get_normals() {
vec4 v_1 = texture(sampler_50, texCoord);
...
float get_roughness() {
float f_5 = texture(sampler_51, texCoord).x;
return f_5;
