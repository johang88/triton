...
uniform sampler2D sampler_25;
uniform sampler2D sampler_26;
uniform sampler2D sampler_27;
vec4 get_diffuse() {
vec4 v_0 = texture(sampler_25, texCoord);
return pow(v_0, vec4(2.2));

}
vec3 get_normals() {
vec4 v_1 = texture(sampler_26, texCoord);
...
float get_roughness() {
float f_5 = texture(sampler_27, texCoord).x;
return f_5;
