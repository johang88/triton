...
uniform sampler2D sampler_17;
uniform sampler2D sampler_18;
uniform sampler2D sampler_19;
uniform sampler2D sampler_20;
vec4 get_diffuse() {
vec4 v_0 = texture(sampler_17, texCoord);
return pow(v_0, vec4(2.2));

}
vec3 get_normals() {
vec4 v_1 = texture(sampler_18, texCoord);
...
float get_metallic() {
float f_4 = texture(sampler_19, texCoord).y;
return f_4;

}
float get_roughness() {
float f_5 = texture(sampler_20, texCoord).x;
return f_5;
