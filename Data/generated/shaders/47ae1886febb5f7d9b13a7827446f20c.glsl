...
uniform sampler2D sampler_31;
uniform sampler2D sampler_32;
uniform sampler2D sampler_33;
vec4 get_diffuse() {
vec4 v_0 = texture(sampler_31, texCoord);
return pow(v_0, vec4(2.2));

}
vec3 get_normals() {
vec4 v_1 = texture(sampler_32, texCoord);
...
float get_roughness() {
float f_5 = texture(sampler_33, texCoord).x;
return f_5;
