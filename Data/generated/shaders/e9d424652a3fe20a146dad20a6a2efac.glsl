...
uniform sampler2D sampler_37;
uniform sampler2D sampler_38;
uniform sampler2D sampler_39;
vec4 get_diffuse() {
vec4 v_0 = texture(sampler_37, texCoord);
return pow(v_0, vec4(2.2));

}
vec3 get_normals() {
vec4 v_1 = texture(sampler_38, texCoord);
...
float get_roughness() {
float f_5 = texture(sampler_39, texCoord).x;
return f_5;
